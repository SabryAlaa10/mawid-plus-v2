...
fun DoctorDetailScreen(
    ...
    Column(
        ...
        Text("Doctor Detail Screen")
        Text("doctorId=$doctorId")
        Button(onClick = { navController.navigateUp() }) { Text("Back") }
        Button(onClick = { navController.navigate(Routes.bookingRoute(doctorId)) }) {
            Text("Book")
        }
        Button(onClick = { navController.navigate(Routes.doctorMapRoute(doctorId)) }) {
            Text("Map")
        }
    }
}
